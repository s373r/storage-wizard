...
pub fn build_parallel_walk_dir_iter(root_path_for_scan: &str) -> ParallelWalkDir {
...
pub fn build_size_based_file_index(walk_dir_iter: ParallelWalkDir) -> SizeBasedFileIndex {
...
pub fn build_hash_based_file_index(
